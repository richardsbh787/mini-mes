...
from app.api.v2.work_order_bom_bind import router as work_order_bom_bind_router
app.include_router(work_order_bom_bind_router)

from app.api.v2.work_order_bom_release import router as work_order_bom_release_router
app.include_router(work_order_bom_release_router)

from app.api.v2.work_order_material_issue_preview import router as work_order_material_issue_preview_router
app.include_router(work_order_material_issue_preview_router)
